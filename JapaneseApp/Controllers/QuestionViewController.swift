...
public class QuestionViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        self.questionView.correctButton.addTarget(
            self,
            action: #selector(self.handleCorrect(_:)),
            for: .touchUpInside)
        self.questionView.incorrectButton.addTarget(
            self,
            action: #selector(self.handleIncorrect(_:)),
            for: .touchUpInside)

...
public class QuestionView: UIView {
    ...
    public var promptView: UIView!

    public var prompLabel = UILabel()
    public var promptImage = UIImageView()
...
//        self.promptImage.translatesAutoresizingMaskIntoConstraints = false
//        NSLayoutConstraint.activate([
//            self.promptImage.topAnchor.constraint(equalTo: self.prompLabel.bottomAnchor),
//            self.promptImage.leadingAnchor.constraint(equalTo: self.leadingAnchor),
//            self.promptImage.trailingAnchor.constraint(equalTo: self.trailingAnchor)
//        ])
//
//        self.addSubview(self.hintLabel)
//        self.hintLabel.translatesAutoresizingMaskIntoConstraints = false
//        NSLayoutConstraint.activate([
//            self.hintLabel.topAnchor.constraint(equalTo: self.promptImage.bottomAnchor),
